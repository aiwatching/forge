...
const IDLE_THRESHOLD = 240000;  // 4min of no file change → check for result entry
const STABLE_THRESHOLD = 300000; // 5min of no change → force done (fallback if hook missed)
